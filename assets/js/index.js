...
const genreList = {
  ...
  //create genre string from ganre_id eg [23,43] -> "Action,Romance"
...
fetchDataFromServer(`https://api.themoviedb.org/3/genre/movie/list?api_key=${api_key}`, function ({ genres }) {
  ...
  fetchDataFromServer(`https://api.themoviedb.org/3/movie/popular?api_key=c8a254596ddcb52c68b7d5ed82d49efa&page=1`, heroBanner)
...
const heroBanner = function ({ results: movieList }) {
 ...
 <div class="banner-content">
   ...
   <div class="meta-list">
     <div class="meta-item">${release_date.split("-")[0]}
    </div>
  ...
  //fetch data for home page sections( top rated, upcomming, trending)
        ...
        <div class="slider-inner">
          <!-- <div class="movie-card">
            <figure class="poster-box card-banner">
              <img src="./assets/images/slider-control.jpg" class="img-cover"
