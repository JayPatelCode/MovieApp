...
//returns only trailer and teasers as array
const filterVideos = function (videoList) {
    return videoList.filter(({ type, site }) => (type === "Trailer" || type === "Teaser") && site === "YouTube");
}

// fetchDataFromServer(`https://api.themoviedb.org/3/movie/${movieId}?api_key=c8a254596ddcb52c68b7d5ed82d49efa&append_to_response=casts,videos,images,releases`, function(movie){
