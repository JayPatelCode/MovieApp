//  search api:https://api.themoviedb.org/3/search/movie?api_key=c8a254596ddcb52c68b7d5ed82d49efa&query=hello&page=1&include_adult=false
...
searchTimeout = setTimeout(function(){
    ...
    fetchDataFromServer(`https://api.themoviedb.org/3/search/movie?api_key=${api_key}&query=${searchField.value}&page=1&include_adult=false`, function({
      ...
      searchResultModel.innerHTML = ""; //remove's old result
